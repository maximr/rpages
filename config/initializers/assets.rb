...
Rails.application.config.assets.precompile += %w( rpages.js rpages_admin.js webfontloader.js jquery.counterup.min.js particles.min.js jquery.flip.min.js jquery.vide.js active_admin_multi_upload/jquery_upload.css ckeditor/config.js )
